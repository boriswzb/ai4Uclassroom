          ...
          >
            <svg viewBox="0 0 40 40" className="h-5 w-5 shrink-0" aria-hidden="true">
              <defs>
                ...
                <linearGradient id="sag" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#f59e0b" />
                  <stop offset="100%" stopColor="#fbbf24" />
                </linearGradient>
              </defs>
              <path d="M8 28 Q8 10 20 10 L20 32 Q8 32 8 28Z" fill="url(#sig)" opacity="0.9"/>
              <path d="M32 28 Q32 10 20 10 L20 32 Q32 32 32 28Z" fill="url(#sig)" opacity="0.7"/>
              <circle cx="20" cy="6" r="3.5" fill="url(#sag)"/>
              <circle cx="9" cy="13" r="2.2" fill="url(#sig)"/>
              <circle cx="31" cy="13" r="2.2" fill="url(#sig)"/>
            ...
            <span className="text-sm font-bold text-primary">AI4U</span>
          </button>
          <button
