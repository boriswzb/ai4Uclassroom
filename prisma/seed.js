...
async function main() {
  ...
  const wh1 = await prisma.warehouse.create({
    data: { code: 'WH-001', name: '总部仓库', location: '深圳市南山区科技园', manager: '李主管', capacity: 5000, used: 3200 }
  })
  const wh2 = await prisma.warehouse.create({
    data: { code: 'WH-002', name: '分部仓库', location: '广州市天河区', manager: '张主管', capacity: 3000, used: 1200 }
  })
